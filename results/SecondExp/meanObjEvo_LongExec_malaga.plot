...
set output "images/SecondExp/meanObjEvo_LongExec_malaga.eps"

plot "results/SecondExp/NSGA2_Multi_DCN/Teide_NSGA2_Multi_DCN_Sumo_malaga_LongExec_Mutate_Pol_Crossover_Uniform_100_0.000210039907582441_1_604800.avgHV.evolution" with linespoints lt -1 pi -3 pt 7 ps 1.5 lc rgb "blue" title "NSGAII-DCN", "results/SecondExp/MonoGA/Teide_MonoGA_Sumo_malaga_LongExec_Mutate_Pol_Crossover_Uniform_100_0.000210039907582441_1_604800.avgHV.evolution" with linespoints lt -1 pi -3 pt 7 ps 1.5 lc rgb "red" title "MonoGA", "results/SecondExp/PSO/Teide_PSO_sumo_malaga.avgHV.evolution" with linespoints lt -1 pi -3 pt 7 ps 1.5 lc rgb "black" title "PSO", "results/SecondExp/VNS/Teide_VNS_sumo_malaga.avgHV.evolution" with linespoints lt -1 pi -3 pt 7 ps 1.5 lc rgb 'yellow' title "VNS"
